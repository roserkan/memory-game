...
export default function LimitedClickMod() {
    ...
    function finish(timeValue, clickValue, click=true){
        const boxCount = document.querySelectorAll('.flip-box').length
        console.log(boxCount, timeValue, clickValue)
    ...
    const again = e => {
        ...
        const fp = document.querySelectorAll('.flip.box').length;
        setCount(fp * 3)
    }
